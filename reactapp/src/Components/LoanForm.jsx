...
// console.log("id------------",id)
  ...
  async function handleAddLoan() {
   ...
   try{
    ...
    if(id)
    {
      const response = await axios.put('https://8080-dedfbebad306621518acccacedaone.premiumproject.examly.io/api/Loan/'+id,requestObject);
    ...
    if (response.status == 204) {
      ...
      const response = await axios.post('https://8080-dedfbebad306621518acccacedaone.premiumproject.examly.io/api/Loan',requestObject);
      console.log("response",response)
